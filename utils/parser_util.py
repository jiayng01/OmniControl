...
def add_model_options(parser):
    ...
    group.add_argument(
        "--arch",
        default="trans_enc",
        choices=["trans_enc", "trans_dec", "gru", "hybrid"],
        type=str,
...
def add_data_options(parser):
    ...
    group.add_argument("--control_joint", default=0, type=int, help="controlling joint")
    group.add_argument("--density", default=100, type=int, help="density")
...
def add_evaluation_options(parser):
    ...
    group.add_argument(
        "--eval_mode", default="omnicontrol", choices=["omnicontrol"], type=str, help=""
    )
    group.add_argument(
        "--guidance_param",
        default=2.5,
