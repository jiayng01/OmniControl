...
def unnatural_text_control_example(n_frames=120, raw_mean=None, raw_std=None, index=0):
    ...
    for i in range(len(control)):
        ...
        control_ = (
            control[i] - raw_mean.reshape(22, 1, 3)[joint_id[i]]
        ) / raw_std.reshape(22, 1, 3)[joint_id[i]]
...
def combination_text_control_example(
    n_frames=120, raw_mean=None, raw_std=None, index=0
):
    """
...
def pelvis_dense_text_control_example(
    n_frames=120, raw_mean=None, raw_std=None, index=0
):
    text = [
        # pelvis
    ...
    control = [
        ...
        # circle
        circle(
            n_frames, r=0.8, indices=[0, 2], x_offset=0.0, y_offset=0.8, z_offset=0.0
        ),
        # short s
        s_line(n_frames, indices=[2, 0], x_offset=0.0, y_offset=0.8, z_offset=0.0),
        # straight line
        straight_diagonal_uniform(
            n_frames,
            indices=[0, 2],
            scale=9.0,
            x_offset=0.0,
        ...
        # duck walk
        straight_diagonal_uniform(
            n_frames, indices=[0, 2], scale=4, x_offset=0.0, y_offset=0.6, z_offset=0.0
        ),
        # step walk
        straight_forward_step_uniform(
            n_frames, indices=[0, 2], scale=4, x_offset=0.0, y_offset=0.9, z_offset=0.0
        ),
        # step walk
        circle(
            n_frames, r=0.8, indices=[0, 2], x_offset=0.0, y_offset=0.9, z_offset=0.0
        ),
    ]
    joint_id = np.array(
        [
...
def pelvis_sparse_text_control_example(
    n_frames=120, raw_mean=None, raw_std=None, index=0
):
    text = [
        # pelvis
...
def wrist_text_control_example(n_frames=120, raw_mean=None, raw_std=None, index=0):
    ...
    control = [
        # pelvis
        straight_forward_uniform(
            n_frames, indices=[2], scale=8, x_offset=-0.4, y_offset=1.35, z_offset=0.0
        ),
        specify_points(n_frames, [[80, -0.15, 0.6, 1.2], [160, 1.8, 0.6, 1.2]]),
        specify_points(n_frames, [[160, 0, 0.2, 2.0]]),
        circle(
            n_frames, r=0.01, indices=[0, 2], x_offset=-0.15, y_offset=0.8, z_offset=1.5
        ),
        # ---
        straight_fb(
            n_frames,
        ...
        straight_fb(
            n_frames, indices=[1, 2], scale=0.5, x_offset=0, y_offset=0.6, z_offset=0.5
        ),
        straight_fb(
            n_frames,
            indices=[1, 2],
        ...
        circle(
            n_frames, r=0.01, indices=[0, 2], x_offset=0.0, y_offset=0.5, z_offset=0.0
        ),
        circle(
            n_frames, r=0.01, indices=[0, 2], x_offset=0.5, y_offset=0.5, z_offset=0.5
        ),
        circle(
            n_frames, r=0.01, indices=[0, 2], x_offset=0.5, y_offset=1.6, z_offset=0.5
        ),
    ]
    joint_id = np.array(
        [
...
def head_text_control_example(n_frames=120, raw_mean=None, raw_std=None, index=0):
    ...
    control = [
        # head
        straight_forward_uniform(
            n_frames, indices=[2], scale=5, x_offset=0, y_offset=1.5, z_offset=0.0
        ),
        # long s
        s_line_long(
            n_frames,
        ...
        circle(
            n_frames, r=0.7, indices=[0, 2], x_offset=0.0, y_offset=1.6, z_offset=0.0
        ),
...
def circle(
    n_frames=120, r=0.8, indices=[0, 2], x_offset=0.5, y_offset=0.9, z_offset=0.5
):
...
def straight(
    n_frames=120, indices=[1, 2], scale=1.0, x_offset=0.5, y_offset=0.5, z_offset=0.5
):
    hint = np.zeros((n_frames, 3))
...
def straight_fb(
    n_frames=120, indices=[1, 2], scale=0.5, x_offset=0.5, y_offset=0.6, z_offset=0.5
):
    hint = np.zeros((n_frames, 3))
...
def collate_all(n_frames, dataset):
    ...
    texts5, hints5, _ = unnatural_text_control_example(
        n_frames, raw_mean, raw_std, index=0
    )
    texts6, hints6, _ = combination_text_control_example(
        n_frames, raw_mean, raw_std, index=0
    )
    ...
    hints = np.concatenate(
        [hints0, hints1, hints2, hints3, hints4, hints5, hints6, hints7], axis=0
    )
    return texts, hints
