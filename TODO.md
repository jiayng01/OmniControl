...
python -m sample.generate --model_path ./save/omnicontrol_ckpt/model_humanml3d.pt --num_repetitions 1 --text_prompt 'walk clockwise twice, then to the right 2 steps' --use_ddim True --timestep_respacing ddim500
